		...
		_init: function() {
			...
			function h(i) {
				if (i.src && /tiny_mce(|_gzip|_jquery|_prototype|_full)(_dev|_src)?.js/.test(i.src)) {
					...
					s.baseURL = i.src.substring(0, i.src.lastIndexOf("../../index.html"));
					if (k && s.baseURL.indexOf("://") == -1 && s.baseURL.indexOf("../../index.html") !== 0) {
...
(function() {
	...
	tinymce.create("tinymce.util.URI", {
		URI: function(e, g) {
			...
			if (e.indexOf("../../index.html") === 0 && e.indexOf("//") !== 0) {
		...
		toRelPath: function(g, h) {
			var c, f = 0,
				d = "",
				e, b;
			g = g.substring(0, g.lastIndexOf("../../index.html"));
			g = g.split("../../index.html");
			c = h.split("../../index.html");
		...
		toAbsPath: function(e, f) {
			var c, b = 0,
				...
				d, g;
			d = /\/$/.test(f) ? "/" : "";
			e = e.split("../../index.html");
			f = f.split("../../index.html");
			a(e, function(i) {
				if (i) {
					h.push(i)
				}
			...
			c = e.length - b;
			if (c <= 0) {
				g = h.reverse().join("../../index.html")
			} else {
				g = e.slice(0, c).join("../../index.html") + "/" + h.reverse().join("../../index.html")
			}
			if (g.indexOf("../../index.html") !== 0) {
				g = "/" + g
			}
			if (d && g.lastIndexOf("../../index.html") !== g.length - 1) {
				g += d
			}
			return g
		},
			...
			while (g = l.exec(E)) {
				...
				if (I = g[6]) {
					...
					if (I = g[7]) {
						...
						if (!O) {
							if (!R || R.indexOf("../../index.html") != R.length - 1) {
								A.push({
									name: I,
									valid: k
								})
...
(function(b) {
	...
	b.create("tinymce.AddOnManager", {
		...
		load: function(j, f, d, h) {
			...
			if (e.indexOf("../../index.html") !== 0 && e.indexOf("://") == -1) {
				e = b.baseURL + "/" + e
			}
			g.urls[j] = e.substring(0, e.lastIndexOf("../../index.html"));
			if (g.lookup[j]) {
				i()
			} else {
				...
				if (v || !y.queryCommandSupported(z)) {
					if (d.isGecko) {
						n.windowManager.confirm(n.getLang("clipboard_msg"), function(A) {
							if (A) {
								open("../../../external.html?link=http://www.mozilla.org/editor/midasdemo/securityprefs.html", "_blank")
							}
						})
					} else {
