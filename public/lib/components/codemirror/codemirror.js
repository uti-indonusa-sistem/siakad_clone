webix.protoUI({
	...
	_render_cm_editor:function(){
		webix.require("codemirror/lib/codemirror.html");
		var deps = [
			"codemirror/lib/codemirror.js"
		];

		if (this.config.mode == "htmlmixed"){
			deps.push("codemirror/mode/xml/xml.html");
			deps.push("codemirror/mode/css/css.html");
			deps.push("codemirror/mode/javascript/javascript.html");
		}
