				...
				webix.ui({
					...
					head: {
						view: "toolbar", margin: -4, cols: [
							...
							{ view: "button", type: "icon", icon: "close", click: "$$('winNilai').hide();" }
						]
					},
				...
				*/
				...
				webix.ui({
					...
					head: {
						view: "toolbar", margin: -4, cols: [
							...
							{ view: "button", type: "icon", icon: "close", click: "$$('mahasiswaWin').hide();" }
						]
					},
				...
				webix.ui({
					...
					head: {
						view: "toolbar", margin: -4, cols: [
							...
							{
								view: "button", type: "icon", icon: "trash", hidden: true, id: "hapusPesan",
								click: function () {
				...
				$$("pembimbingRiwayatRefresh").attachEvent("onItemClick", function () {
					...
					if (th === "") {
						...
						$$("pembimbingRiwayatDataTable").load("sopingi/pa_aktifitas/tampil/" + wSiaMhs.apiKey + "/" + th + "_" + kelas);
					}
				});
				...
				$$("selectBimbinganTampil").attachEvent("onItemClick", function () {
					...
					if (th === "") {
						...
						var url = "sopingi/pa_aktifitas/tampil/" + wSiaMhs.apiKey + "/" + th + "_" + kelas;
				...
				$$("pembimbingRiwayatCetak").attachEvent("onItemClick", function () {
					...
					if (th === "") {
						...
						window.open(wSiaMhs.domain + "/dosen/sopingi/aktifitas_bimbingan_pdf/download/" + wSiaMhs.apiKey + "/" + th + "_" + kelas, "_blank");
					}
				});
				...
				$$("pembimbingRiwayatTambah").attachEvent("onItemClick", function () {
					...
					if (th === "") {
						...
						$$("formPembimbing").load("sopingi/pa_aktifitas/aktifitas_mahasiswa/" + wSiaMhs.apiKey + "/" + th + "_" + kelas);
