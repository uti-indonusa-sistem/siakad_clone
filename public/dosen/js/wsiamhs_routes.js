...
var aksesDitolak = new WebixView({
  config: {
    ...
    rows: [
      ...
      {
        template:
          "<h2 align='center'>Maaf, akses KRS ditolak. Silahkan melakukan tagihan pembayaran atau hubungi admin</h2>",
        height: 70,
      },
      { template: "" },
    ],
    ...
    rows: [
      {
        ...
        css: "toolbar_premium",
        cols: [
          { view: "label", label: "PENGATURAN AKUN DOSEN", css: "header_title" },
          {},
        ],
      },
      {
          ...
          rows: [
            {
              cols: [
                {
                  // Kolom Kiri: Profil & Foto & Google Link
                  width: 350,
                  rows: [
                    {
                      view: "form",
                          ...
                          template: function (obj) {
                            ...
                            return `<center>
                                        <div class='profile_image_container'>
                                            <img src='foto/${wSiaMhs.nidnMd5}.jpg?v=${timestamp}' class='profile_img' onerror="this.src='../gambar/no-foto.jpg'">
                                        </div>
                                    </center>`;
                          },
                          height: 180,
                          ...
                          on: {
                            onBeforeFileAdd: function (item) {
                              ...
                              if (type != "jpg" && type != "png" && type != "jpeg") {
                                webix.message("Hanya file JPG, JPEG, atau PNG yang diperbolehkan");
                                return false;
                              }
                              $$("updateFoto").show();
                            ...
                            onFileUpload: function (item, response) {
                              var timestamp = new Date().getTime();
                              $$("fotoMhs").setHTML("<center><div class='profile_image_container'><img src='foto/" + wSiaMhs.nidnMd5 + ".jpg?v=" + timestamp + "' class='profile_img'></div></center>");
                              if (item && item.id) $$("foto").files.remove(item.id);
                              webix.message({ type: "success", text: "Foto berhasil diupload" });
                              $$("updateFoto").hide();
                            }
                          }
                        },
                        {
                          view: "button", id: "updateFoto", label: "Upload Sekarang",
                          css: "webix_primary", height: 45, hidden: true,
                          click: function () { updateFoto(); }
                        }
                      ],
                    },
                    { height: 20 },
                    {
                      ...
                      elements: [
                        {
                          template: "<div class='card_title'>Login Google</div>",
                          height: 35,
                          borderless: true,
                        },
                        {
                          template: "<div class='card_desc'>Tautkan akun Google Poltek untuk kemudahan login Bapak/Ibu.</div>",
                          height: 60,
                          borderless: true,
                        },
                        {
                          ...
                          on: {
                            onAfterRender: function () {
                              var scope = this;
                              webix.ajax().get("sopingi/profil/tampil/" + wSiaMhs.apiKey + "/" + Math.random(), function (text) {
                                var data = JSON.parse(text);
                                var container = scope.$view.querySelector(".google_link_btn_v2");
                                if (data.email_poltek) {
                                  ...
                                  if (typeof google !== "undefined") {
                                    google.accounts.id.initialize({
                                      client_id: "594821951155-gjnu9qb2g2sltb67qvrr6frjmggvc6n5.apps.googleusercontent.com",
                  ...
                  rows: [
                    {
                      ...
                      elements: [
                        {
                          template: "<div class='card_title'><i class='fa fa-lock'></i> Keamanan SIAKAD</div>",
                          height: 35,
                          borderless: true,
                        },
                        {
                          view: "text", id: "pass", name: "pass", type: "password",
                          label: "Password Lama", labelPosition: "top", required: true,
                          placeholder: "Isi password saat ini",
                        },
                        {
                          view: "text", id: "passBaru1", name: "passBaru1", type: "password",
                          label: "Password Baru", labelPosition: "top", required: true,
                          placeholder: "Min. 6 karakter",
                        },
                        {
                          view: "text", id: "passBaru", name: "passBaru", type: "password",
                          label: "Konfirmasi Password Baru", labelPosition: "top", required: true,
                          placeholder: "Ulangi password baru",
                        },
                        { view: "text", id: "aksi", name: "aksi", value: "ubahAkun", hidden: true },
                        { height: 20 },
                        {
                          view: "button", id: "simpanAkun", label: "Ganti Password",
                          css: "webix_primary", height: 45, inputHeight: 45, css: "btn_action"
                        }
                      ],
                    },
                    { template: "" }
    ...
    },
    {
      ...
      columns: [
        ...
        { id: "nm_mk", header: "Nama MK", fillspace: true },
        {
          ...
          width: 90,
          template:
            "<button class='btnNilai btnTransparant'><i class='webix_icon fa-users'></i> Mhs</button>",
        },
      ],
  ...
  cols: [
    {
      ...
      rows: [
        ...
        {
          template:
            "<span style='background:#ffff00;font-size:13pt;font-weight:bold'>Pengumpulan nilai maksimal 7 hari setelah UAS</span>",
        },
        {
          view: "toolbar",
          cols: [
      ...
      rows: [
        ...
        },
        {
          ...
          columns: [
            ...
            { id: "nipd", header: "NIM", sort: "string", width: 70 },
            ...
            },
            {
              id: "nilai_absen",
              header: [
                { text: "Nilai", colspan: 7, css: { "text-align": "center" } },
                {
                  text: "Kehadiran",
                  css: {
                    "text-align": "center",
            ...
            {
              id: "nilai_status",
              header: ["Status Nilai", { content: "selectFilter" }],
              width: 100,
            },
          ],
          ...
          on: {
              ...
              if (!$$("formPersenNilai").validate()) {
                ...
                webix.alert({
                  ...
                  text:
                    "Nilai mahasiswa: " +
                    row.nm_pd +
                    " tidak diperkenankan diubah, karena status Nilai diisi oleh BAAK atau Sudah TERKIRIM",
                  type: "alert-warning",
                });
                this.editCancel();
                return false;
            ...
            onAfterEditStop: function (data, editor, ignoreUpdate) {
              ...
              if (
                parseFloat(record.nilai_absen) > 100 ||
                parseFloat(record.nilai_absen) < 0
              ) {
                record.nilai_absen = "";
              }
              if (
                parseFloat(record.nilai_tugas) > 100 ||
                parseFloat(record.nilai_tugas) < 0
              ) {
                record.nilai_tugas = "";
              }
              if (
                parseFloat(record.nilai_uts) > 100 ||
                parseFloat(record.nilai_uts) < 0
              ) {
                record.nilai_uts = "";
              }
              if (
                parseFloat(record.nilai_uas) > 100 ||
                parseFloat(record.nilai_uas) < 0
              ) {
                record.nilai_uas = "";
              }

              if (
                String(record.nilai_absen || "") == "" &&
                String(record.nilai_tugas || "") == "" &&
                String(record.nilai_uts || "") == "" &&
                String(record.nilai_uas || "") == ""
              ) {
                ...
                var nilai_absen =
                  (parseFloat(record.nilai_absen) || 0) *
                  (parseFloat(formNilai.persen_absen) / 100);
                var nilai_tugas =
                  (parseFloat(record.nilai_tugas) || 0) *
                  (parseFloat(formNilai.persen_tugas) / 100);
                var nilai_uts =
                  (parseFloat(record.nilai_uts) || 0) *
                  (parseFloat(formNilai.persen_uts) / 100);
                var nilai_uas =
                  (parseFloat(record.nilai_uas) || 0) *
                  (parseFloat(formNilai.persen_uas) / 100);
                var nilai_angka =
        ...
        },
        {
          ...
          template:
            "{common.prev()} {common.pages()} {common.next()} Total: <b><span id='jMahasiswaKelas'>  </span></b> Mahasiswa &nbsp;&nbsp; KETERANGAN : Nilai Absen, Tugas, UTS dan UAS Wajib Diisi",
          size: 15,
          group: 5,
          animate: {
            direction: "left",
...
var menuBimbinganAkademik = {
  ...
  rows: [
    ...
    },
    {
      ...
      scroll: true,
      url:
        "sopingi/siakad_angkatan/pilihV1/" +
        wSiaMhs.apiKey +
        "/" +
        Math.random(),
    },
  ...
  rows: [
    {
      ...
      cols: [
        {
          view: "button",
          id: "bimbinganAkademikRiwayatRefresh",
          label: "Refresh",
          type: "iconButton",
          icon: "refresh",
          width: 100,
        ...
        {
          view: "button",
          id: "bimbinganAkademikRiwayatCetak",
          label: "Presensi",
          type: "iconButton",
          icon: "download",
          width: 100,
    ...
    },
    {
      ...
      columns: [
        ...
        { id: "vid_jns_daftar", header: "Jenis Daftar", width: 150 },
        {
          ...
          width: 100,
          template:
            "<button class='btnDetail btnTransparant'><i class='webix_icon fa-users'></i> Detail</button>",
        },
      ],
...

    {
      ...
      template:
        "{common.prev()} {common.pages()} {common.next()} Total: <b><span id='jBimbinganAkademik'>  </span></b> Data",
      size: 12,
      group: 5,
      animate: {
        direction: "left",
            ...
            { template: " ", borderless: true, width: 50 },
            {
              ...
              rows: [
                ...
                },
                {
                  ...
                  options:
                    "sopingi/sms/pilih/" + wSiaMhs.apiKey + "/" + Math.random(),
                  value: "",
                  inputWidth: 450,
                  labelWidth: 150,
                  readonly: true,
...
var formKRS = {
  rows: [
    ...
    },
    {
      cols: [
        { template: " ", borderless: true },
        { view: "button", type: "icon", icon: "hand-o-right" },
        {
          view: "button",
          id: "simpanKRS",
      ...
      cols: [
        {
          view: "label",
          id: "judulKrs",
          template: "KRS Mahasiswa pada Semester Aktif saat ini",
          borderless: true,
        },
  ...
  rows: [
    {
      ...
      cols: [
        {
          view: "label",
          template: "History Nilai Mahasiswa",
          borderless: true,
        },
        {},
        {
    ...
    },
    {
      cols: [
        ...
        {
          view: "template",
          template: "Nilai Huruf Merah Artinya: Nilai Tunda atau Belum Diisi",
        },
        {
          view: "template",
          template: "Index Prestasi Komulatif: <b><span id='IPS'></span></b>",
        },
      ],
    },
  ],
...
var viewMahasiswaAktifitas = {
  ...
  rows: [
    ...
    },
    {
      ...
      css: "pager",
      template:
        "{common.prev()} {common.pages()} {common.next()} Total: <b><span id='jAktifitas'>0</span></b> Data",
      size: 15,
      group: 5,
      animate: {
        direction: "left",
    ...
    {
      template:
        "Jika SKS dan IPK terakhir tidak sesuai dengan Histori Nilai. Mungkin BAAK belum update aktifitas Mahasiswa",
      height: 60,
    },
  ],
};
...
function createPanelKiriPembimbing() {
  return {
    ...
    rows: [
      ...
      },
      {
        ...
        select: true,
        scroll: true,
        url: "sopingi/semester/pilih/" + webix.storage.session.get('wSiaMhs').apiKey + "/" + Math.random(),
      },
    ],
  };
}

function createDosenPembimbingRiwayat() {
  var wSiaMhs = webix.storage.session.get('wSiaMhs');
  return {
...
function createPembimbingDetail() {
  return new WebixView({
    config: {
      id: "pembimbingDetail",
      type: "clean",
      rows: [
        ...
        { cols: [createPanelKiriPembimbing(), createDosenPembimbingRiwayat()] },
      ],
    },
  });
}
