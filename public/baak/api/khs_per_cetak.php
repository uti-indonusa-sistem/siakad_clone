...
if ($xid_reg_pd!="") {
	...
	$KHS="Tidak ada data";
	  	...
	  	$i++;
		 $qryMhsKrs = "select wsia_nilai.xid_kls, wsia_nilai.xid_reg_pd as vid_reg_pd, nipd, nm_pd,xid_sms,nm_jenj_didik,nm_lemb,pa from wsia_nilai,wsia_mahasiswa,wsia_mahasiswa_pt,wsia_kelas_kuliah,wsia_sms,wsia_jenjang_pendidikan where wsia_nilai.xid_kls=wsia_kelas_kuliah.xid_kls and wsia_mahasiswa_pt.xid_reg_pd=wsia_nilai.xid_reg_pd and wsia_mahasiswa.xid_pd=wsia_mahasiswa_pt.id_pd and wsia_mahasiswa_pt.id_sms=wsia_sms.xid_sms and wsia_sms.id_jenj_didik=wsia_jenjang_pendidikan.id_jenj_didik and wsia_mahasiswa_pt.xid_reg_pd='$xid_reg_pd' and wsia_kelas_kuliah.id_smt='$id_smt' group by  wsia_mahasiswa_pt.xid_reg_pd";
		  try {
			    	$db 	= koneksi();
	...
	$file="KHS-POLINUS-".$dataMhsKrs->nipd."-".$id_smt.".doc";
	$doc->output($file);
