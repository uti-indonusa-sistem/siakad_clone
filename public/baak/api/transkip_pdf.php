...
$mpdf->setHTMLFooter('<div style="text-align:right;font-size:8pt">hal {PAGENO} dari {nbpg}</div>');
...
$header = "
	<table width='100%' align='left'>
	 <tr>
	    <td rowspan='2' align='center' width='80' valign='center'><img src='../gambar/logo_pt.jpg' height='90'></td>
	  ...
	  <tr>
	    <td align='center' colspan='2'><h3><u>TRANSKIP NILAI</u></h3> </td>
	  </tr>
	</table>";
...
$mpdf->Output('TRANSKIP_'.$dataMhsKrs->nipd.'.pdf','D');
